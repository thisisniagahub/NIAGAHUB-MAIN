...
export const LoginPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (localStorage.getItem('niagahub_user')) {
        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md bg-neutral-900/50 border border-neutral-800 rounded-2xl p-8 backdrop-blur-md shadow-2xl z-10 relative">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-white tracking-tight">NiagaHub OS</h1>
                ...
                <div className="mt-6 pt-4 border-t border-neutral-800">
                    <div className="bg-neutral-800/50 p-3 rounded-lg text-center">
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex items-center justify-center gap-2 text-xs text-neutral-300 cursor-pointer hover:text-white" onClick={() => setEmail('admin@niagahub.os')}>
                                <Icons.User size={12} /> admin@niagahub.os
                            </div>
